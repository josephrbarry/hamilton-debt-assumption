...
# ---------------------------------------------------------------- 9. opinion
w("## 9. Opinion\n")
w("**On the allocation method:** not defensible as an apportionment. The quotas were set on "
  "incomplete returns, cut arbitrarily for the two largest claimants, and assigned by round "
  "number to four states with no data. One dollar in five sits in the wrong state against any "
  "population base.")
w("")
w(f"**On the outcome:** defensible, and better than the method deserved. Utilization was {df.assumed_usd.sum() / total_quota:.0%}, "
  "the states that over-subscribed were exactly the ones Hamilton's Schedule E said had the "
  "most debt, and the 1793 settlement independently confirmed that the biggest recipients "
  "(MA, SC) were the biggest creditors of the Union. Relief tracked contribution.")
w("")
...
w("**On Hamilton's rationale:** the 'bind the creditors to the federal government' argument "
  ...
  "it would need subscriber-level records. What it can say is that the state-level allocation "
  "was rough, honest about its own gaps, and reconciled within three years.")
